...
| Project | Type | Category | Stack | Live | Code |
|---|:---:|---|---|:---:|:---:|
...
| **FreeDownload** — Media downloader | S | Utility / Web Tool | HTML, CSS, JS | [Live](https://freedownload.vercel.app/) | [Code]() |
| **Side Skills** — Developer resources directory | S | Bookmark / Resource Hub | HTML, CSS, JS | [Live](https://side-skills.vercel.app/) | [Code]() |
