...
[![](https://skillicons.dev/icons?i=c,cpp,py,html,css,tailwind,java,js,github,vscode,pycharm,idea,eclipse,windows,apple,blender,figma,ps,pr,au,ai)](https://github.com/armanhossen-dev)<br/>
