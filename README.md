...
[![My Skills](https://skillicons.dev/icons?i=c,cpp,py,pycharm,java,idea,vscode,js,html,css,figma,ps,au,pr,github,gmail,linux,windows,ios,powershell)](https://skillicons.dev)
