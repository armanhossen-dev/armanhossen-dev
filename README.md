...
[![](https://skillicons.dev/icons?i=c,cpp,py,html,css,tailwind,java,js,php,mysql,github,vscode,pycharm,idea,eclipse,windows,apple,linux,blender,arduino,ps,pr,au,ai,androidstudio,arduino,ubuntu&perline=14)](https://github.com/armanhossen-dev)   
...
|:---:|---|:---:|---|---|:---:|:---:|
| 1 | **IrrigaTech** — Smart irrigation app | ![S](https://img.shields.io/badge/S-39d353?style=for-the-badge) | Mobile App | Kotlin, Android | — | [Code](https://github.com/armanhossen-dev/IrrigaTech) |
| 2 | **Asha Bank** — Banking management system | ![A](https://img.shields.io/badge/A-0366D6?style=for-the-badge) | Full-Stack | PHP, MySQL, JS | — | [Code](https://github.com/armanhossen-dev/BMS) |
| 3 | **StudentNest** — Housing portal | ![A](https://img.shields.io/badge/A-0366D6?style=for-the-badge) | Desktop App | Java, JavaFX | — | [Code](https://github.com/armanhossen-dev/StudentNest) |
| 4 | **UNLOCKEDSTUDIO** — Digital storefront | ![S](https://img.shields.io/badge/S-39d353?style=for-the-badge) | Web Platform | HTML, CSS, JS | [Live](https://unlockedstudio.vercel.app) | [Code](https://github.com/armanhossen-dev/ustudio-v2.0) |
| 5 | **AHRN Portfolio** — Developer site | ![S](https://img.shields.io/badge/S-39d353?style=for-the-badge) | Portfolio | HTML, CSS, JS | [Live](https://www.armanhossen.is-a.dev) | — |
